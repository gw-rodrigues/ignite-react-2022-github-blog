...
export function Comment(comment: IBlogCommentsProps) {
  return (
    <li className="flex flex-col md:flex-row items-center md:items-start flex-wrap bg-base-post rounded-lg p-8 gap-8 justify-between">
      ...
      <div className="w-full gap-2 flex flex-wrap items-center justify-center lg:justify-between">
        <div className="flex gap-4 md:mt-4 items-center justify-center">
